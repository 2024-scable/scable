...
const LicenseDetail: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const fetchPackageData = async () => {
            try {
                ...
                const packagesUsingLicense = jsonData.components.filter(
                    (pkg: any) => pkg.licenses && pkg.licenses.toLowerCase().trim() === licensename?.toLowerCase().trim()
                );
    ...
    // Updated function to include both text color and background color
        ...
        <div className="p-8 bg-gray-50 min-h-screen flex flex-col items-center">
            <div className="bg-white rounded-3xl shadow-lg max-w-5xl w-full p-8">
                ...
                <div className="flex space-x-8 border-b-2 border-gray-200 mb-8">
                    <button className="text-gray-800 font-semibold pb-2 border-b-2 border-blue-600">Details</button>
                </div>
                ...
                {/* Restriction and Disclosure tables */}
                <div className="mt-10">
