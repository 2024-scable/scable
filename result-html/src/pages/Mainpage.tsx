          ...
          <table className="min-w-full text-left">
            <thead>
              <tr className="bg-[#DCEAF7]">
                ...
                <th className="py-2 px-4 font-medium text-gray-700">생성일자</th>
                  ...
                  <React.Fragment key={projectName}>
                    ...
                    {expandedProjects.has(projectName) &&
                      projectGroup.map((project, subIndex) => (
                        ...
                        >
                          <td className="py-2 px-4">
                            <span className="text-gray-700 font-medium">{`${index + 1}.${subIndex + 1}.`}</span>
                          </td>
                          ...
                          <td className="py-2 px-4">
                            <div className="text-gray-700">{project.time}</div>
                          </td>
                          <td className="py-2 px-4">
                            <div className="flex items-center space-x-2">
                              <button
